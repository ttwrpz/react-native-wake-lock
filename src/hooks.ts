...
import type { WakeLockOptions, WakeLockHookResult, WakeLockWithTouchResult } from './types';
 ...
 */
export function useWakeLockWithTouch(options: WakeLockOptions = {}): WakeLockWithTouchResult {
